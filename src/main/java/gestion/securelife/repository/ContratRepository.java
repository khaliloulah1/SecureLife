...
public interface ContratRepository extends JpaRepository<Contrat, String>, JpaSpecificationExecutor<Contrat> {
    ...
    boolean existsByClientIdAndStatus(Integer clientId, ContratStatus status);
    List<Contrat> findByClientId(Integer clientId, PageRequest pageRequest); // <== méthode à ajouter
